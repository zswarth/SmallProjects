		...
		def fillAges(row, grouped_median):
			if row['Sex']=='female' and row['Pclass'] == 1:
				if row['Title'] == 'Miss':
					...
					return grouped_median.loc['female', 1, 'Rare']['Age']
				elif row['Title'] == 'Master':
					return grouped_median.loc['female', 1, 'Master']['Age']
				...
				if row['Title'] == 'Miss':
					...
					return grouped_median.loc['female', 2, 'Rare']['Age']
				elif row['Title'] == 'Master':
					return grouped_median.loc['female', 2, 'Master']['Age']
				...
				if row['Title'] == 'Miss':
					...
					return grouped_median.loc['female', 3, 'Rare']['Age']
				elif row['Title'] == 'Master':
					return grouped_median.loc['female', 3, 'Master']['Age']
				...
				if row['Title'] == 'Master':
					...
					return grouped_median.loc['male', 2, 'Rare']['Age']
				...
				if row['Title'] == 'Master':
					...
					return grouped_median.loc['male', 3, 'Rare']['Age']
...
class Visualize_Model(Train_Model):
	...
	def CorrectBySex(self):
		correct = self.Results[self.Results['Correct']]['Sex'].value_counts().    #got rid of == Ture stament
		incorrect = self.Results[~self.Results['Correct']]['Sex'].value_counts()
